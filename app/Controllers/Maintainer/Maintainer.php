...
namespace App\Controllers\Maintainer;
use App\Controllers\General;
use Config\Services;

class Maintainer extends General
{
    ...
    public function dashboard()
    {
        ...
        return view('dashboard/maintainer_dashboard', $this->data);
    }
    public function assigned_assert()
    {
        ...
        $this->data['workers_data'] = $this->usermodel->select("id,username,firstname")->where($where_workers)->get()->getResult();
        return view('maintainer/assigned_assert', $this->data);
    }
