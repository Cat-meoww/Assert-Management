...
<!-- Mirrored from templates.iqonic.design/cloudbox/html/backend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 May 2022 05:54:51 GMT -->
                                                ...
                                                <div class="profile-header">
                                                    <div class="cover-container text-center">
                                                        ...
                                                        <div class="profile-detail mt-3">
                                                            <h5><a href="https://templates.iqonic.design/cloudbox/html/app/user-profile-edit.html">Panny
                                                                    Marco</a></h5>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="select-dropdown input-prepend input-append">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <div class="item"><i class="ri-folder-add-line pr-3"></i>New Folder
                                                </div>
                                            </li>
                                            <li>
                                                <div class="item"><i class="ri-file-upload-line pr-3"></i>Upload Files
                                                </div>
                                            </li>
                                            <li>
                                                <div class="item"><i class="ri-folder-upload-line pr-3"></i>Upload
                                                    Folders</div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="card-body property2-content">
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="col-lg-6 col-sm-6 p-0">
                                        ...
                                        <p class="mb-5">You have 32 new notifications and 23 unread messages to reply
                                        </p>
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                ...
                                <a href="page-alexa.html" class="folder">
                                    ...
                                    <p class="mb-2"><i class="lar la-clock text-danger mr-2 font-size-20"></i> 10 Dec,
                                        2020</p>
                                    <p class="mb-0"><i class="las la-file-alt text-danger mr-2 font-size-20"></i> 08
                                        Files</p>
                                </a>
                                </a>
                            </div>
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                ...
                                <a href="page-android.html" class="folder">
                                    ...
                                    <p class="mb-2"><i class="lar la-clock text-primary mr-2 font-size-20"></i> 09 Dec,
                                        2020</p>
                                    <p class="mb-0"><i class="las la-file-alt text-primary mr-2 font-size-20"></i> 08
                                        Files</p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                ...
                                <a href="page-brightspot.html" class="folder">
                                    ...
                                    <p class="mb-2"><i class="lar la-clock text-info mr-2 font-size-20"></i> 07 Dec,
                                        2020</p>
                                    <p class="mb-0"><i class="las la-file-alt text-info mr-2 font-size-20"></i> 08 Files
                                    </p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                ...
                                <a href="page-ionic.html" class="folder">
                                    ...
                                    <p class="mb-2"><i class="lar la-clock text-success mr-2 font-size-20"></i> 06 Dec,
                                        2020</p>
                                    <p class="mb-0"><i class="las la-file-alt text-success mr-2 font-size-20"></i> 08
                                        Files</p>
                                </a>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div data-load-file="file" data-load-target="#resolte-contaniner" data-url="../assets/vendor/doc-viewer/files/demo.pdf" data-toggle="modal" data-target="#exampleModal" data-title="Weekly-report.pdf" style="cursor: pointer;">
                                                            Weekly-report.pdf</div>
                                                    </div>
                                                </td>
                                                <td>Me</td>
                                            ...
                                            <tr class="active">
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div data-load-file="file" data-load-target="#resolte-contaniner" data-url="../assets/vendor/doc-viewer/files/demo.pdf" data-toggle="modal" data-target="#exampleModal" data-title="VueJs.pdf" style="cursor: pointer;">VueJs.pdf
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Poul Molive</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div data-load-file="file" data-load-target="#resolte-contaniner" data-url="../assets/vendor/doc-viewer/files/demo.docx" data-toggle="modal" data-target="#exampleModal" data-title="Milestone.docx" style="cursor: pointer;">
                                                            Milestone.docx</div>
                                                    </div>
                                                </td>
                                                <td>Me</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div data-load-file="file" data-load-target="#resolte-contaniner" data-url="../assets/vendor/doc-viewer/files/demo.xlsx" data-toggle="modal" data-target="#exampleModal" data-title="Training center.xlsx" style="cursor: pointer;">
                                                            Training center.xlsx</div>
                                                    </div>
                                                </td>
                                                <td>Me</td>
                                                <td>Mar 30, 2020 Gail Forcewind</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div data-load-file="file" data-load-target="#resolte-contaniner" data-url="../assets/vendor/doc-viewer/files/demo.pptx" data-toggle="modal" data-target="#exampleModal" data-title="Flavour.pptx" style="cursor: pointer;">
                                                            Flavour.pptx</div>
                                                    </div>
                                                </td>
                                                <td>Me</td>
